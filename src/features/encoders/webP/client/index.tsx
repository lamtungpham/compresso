            ...
            <div>
              ...
              <div class={style.optionOneCell}>
                <Range
                  ...
                  onInput={this.onChange}
                >
                  {t('Alpha filter quality:')}
                </Range>
              </div>
              <label class={style.optionToggle}>
                {t('Auto adjust filter strength')}
                <Checkbox
                  name="autofilter"
              ...
              <label class={style.optionTextFirst}>
                ...
                >
                  ...
                  <option value="1">{t('Segment smooth')}</option>
                  <option value="2">{t('Pseudo-random dithering')}</option>
                </Select>
              </label>
              <div class={style.optionOneCell}>
                <Range
