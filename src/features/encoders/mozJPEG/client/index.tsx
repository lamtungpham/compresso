        ...
        <Expander>
          {showAdvanced ? (
            <div>
                      ...
                      {options.auto_subsample ? null : (
                        <div class={style.optionOneCell}>
                          <Range
                            ...
                            onInput={this.onChange}
                          >
                            {t('Subsample chroma by:')}
                          </Range>
                        </div>
                      )}
                    </Expander>
                    <label class={style.optionToggle}>
                      {t('Separate chroma quality')}
                      <Checkbox
              ...
              <label class={style.optionToggle}>
                {t('Optimize after trellis quantization')}
                <Checkbox
