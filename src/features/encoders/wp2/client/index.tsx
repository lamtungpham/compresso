                ...
                {showAdvanced && (
                  <div>
                    ...
                    <label class={style.optionTextFirst}>
                      ...
                      >
                        <option value={UVMode.UVModeAuto}>{t('Auto')}</option>
                        <option value={UVMode.UVModeAdapt}>{t('Vary')}</option>
                        <option value={UVMode.UVMode420}>{t('Half')}</option>
                        <option value={UVMode.UVMode444}>{t('Off')}</option>
                      </Select>
                    </label>
                    <label class={style.optionTextFirst}>
                      {t('Color space:')}
