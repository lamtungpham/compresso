...
export default class Options extends Component<Props, State> {
  ...
  componentDidMount(): void {
    ...
    // Re-render the whole options subtree when the language changes.
  ...
  render(
    ...
    return (
      ...
      >
              ...
              <h3 class={style.optionsTitle}>
                <div class={style.titleAndButtons}>
                  ...
                  <button
                    ...
                    title={onlyConfig ? t('tip.saveBulk') : t('tip.saveSide')}
        ...
        <h3 class={style.optionsTitle}>{t('opt.compress')}</h3>
        ...
        <section class={`${style.optionOneCell} ${style.optionsSection}`}>
          {supportedEncoderMap ? (
            <Select
              ...
              large
            >
              <option value="identity">{`${t('opt.originalImage')} ${
